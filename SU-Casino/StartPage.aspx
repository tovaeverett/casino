...
<div class="container-fluid smallDev">
    <header class="header">
        <img src="src/images/logos/SU.png" class="img-fluid" title="Stockholms universitet"/>
    </header>
</div>
<div class="container-fluid smallDev">
    ...
    <div class="col-xs-10 col-sm-10 col-xl-8 question-container">
        ...
        <div class="form-group question">
            <fieldset>
                ...
                <asp:TextBox CssClass="radioButtonList" ID="q11" runat="server" TextMode="Number"/>
            </fieldset>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="Please answer this question." CssClass="validationError" Font-Bold="True" SetFocusOnError="True" ForeColor="Red" ControlToValidate="q11" Display="Dynamic"></asp:RequiredFieldValidator>
            <asp:RangeValidator ID="val" runat="server" ErrorMessage="Your age is not valid" SetFocusOnError="true" ControlToValidate="q11" Display="Dynamic" CssClass="validationError" ForeColor="red" Type="Integer" MinimumValue="18" MaximumValue="150"></asp:RangeValidator>
        </div>
