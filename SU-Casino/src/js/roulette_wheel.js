...
var wheelSpinTime = 6;
var ballSpinTime = 5;
var hiddenNumOrder = $("#HiddenField_numorder");
var hiddenRedNum = $("#HiddenField_redNum");
var hiddenBlackNum = $("#HiddenField_blackNum");
var numorder = hiddenNumOrder.val().split(',');
var numred = hiddenRedNum.val().split(',');
var numblack = hiddenBlackNum.val().split(',');
var numgreen = [0];
