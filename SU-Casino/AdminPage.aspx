...
<asp:GridView ID="gvMatris" runat="server" OnRowEditing="gvMatris_RowEditing" AutoGenerateColumns="False" AutoGenerateEditButton="True" AutoGenerateDeleteButton="True" OnRowUpdating="gvMatris_RowUpdating">
    <columns>
        <asp:templatefield headertext="prop_n">
            ...
            <asp:label id="lblRowId" runat="server" Text='<%#Eval("RowId")%>'></asp:label>
                 ...
                 <EditItemTemplate>
                <asp:TextBox ID="txtRditProp_N" runat="server" Text='<%#Eval("prop_n") %>'></asp:TextBox>
            </EditItemTemplate>
        </asp:templatefield>   
        ...
        <asp:templatefield headertext="ifS2win">
          ...
          <asp:templatefield headertext="ifS3win">
            ...
            <EditItemTemplate>
                <asp:TextBox ID="txtEditifS3wine" runat="server" Text='<%#Eval("ifS3win") %>'></asp:TextBox>
            </EditItemTemplate>
        </asp:templatefield>
