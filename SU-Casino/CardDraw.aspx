    ...
    <div class="row playground">
        ...
        <div class="col-xl-8 col-md-8 col-sm-10" id="play-container">
                        ...
                        <div class="scene scene--card">
                            <div class="betCard" id="betCard1">
                                <div class="card__face card__face--front">
                                    <img src="src/images/cards/blue_back_1.png"/>
                                </div>
                                <div class="card__face card__face--back">
                                    <img id="imgCard1" src="src/images/cards/3C.png"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 cardSpan">
                        <div class="scene scene--card">
                            <div class="betCard" id="resultCard">
                                <div class="card__face card__face--front">
                                    <img id="imgCard3" src="src/images/cards/3C.png"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 cardSpan">
                        <div class="scene scene--card">
                            <div class="betCard" id="betCard2">
                                <div class="card__face card__face--front">
                                    <img src="src/images/cards/red_back_1.png"/>
                                </div>
                                <div class="card__face card__face--back">
                                    <img id="imgCard2" src="src/images/cards/2C.png"/>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div runat="server" ID="Jackpot_Banner" class="col-md-12 col-sm-12 jackpot-banner">
                <%-- <img id="slot_2_1" src="src/images/slot/coinsLeft.png"/> --%>
                <div class="x-sign">
                    Jackpot
                </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8 text-center" id="message-content-win">
            <div class="winner">
                ...
                <h2>
                    <span class="winSpan">
                        You won <span id="winCredit"></span> !
                        <span id="piggySpan">
                            <img src="src/images/other/piggy-bank-icon.png"/> <br/>
